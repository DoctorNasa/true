...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.DataViewHolder> {
    ...
    public DataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new
                DataViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_shop_list, parent, false));
    }

    @Override
    public void onBindViewHolder(final DataAdapter.DataViewHolder holder, int
            position) {
...
//        Picasso.with(holder.itemView.getContext()).load(dataModel.thumbnail) .error(R.mipmap.ic_launcher)
